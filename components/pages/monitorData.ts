...
export const MONITOR_GROUPS: MonitorGroup[] = [
  {
    ...
    items: [
      ...
      {
        id: 'worker-status',
        name: 'huny.dev Edge Worker',
        category: 'status',
        summary: 'AI 관련 API, proxy, secure storage 등의 경량 처리 담당.',
        updatedAt: '2025-09-26T08:40:00+09:00',
        statusLevel: 'degraded',
        statusLabel: '부분 지연',
        statusIcon: 'activityDocs',
        metrics: [
          { label: 'Requests(1h)', value: '12.4K', change: '+7%', trend: 'up' },
          { label: '오류율', value: '0.42%', change: '+0.12%', trend: 'down', helper: 'Gemini API 429 상승' },
          { label: '평균 처리 시간', value: '143 ms', change: '+21 ms', trend: 'down' },
        ],
        notes: 'Gemini API 쿼터 근접. 저녁 시간대 추가 캐시 전략 필요.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description: '사건/사고 이력 및 대응 현황을 복기합니다.',
    icon: 'activityBlog',
    items: [
      {
        id: 'incident-2025-09-dns',
        name: '2025-09-12 DNS Failover',
        category: 'incident',
        summary: 'Cloudflare Secondary DNS 동기화 지연으로 일부 국가에서 5분간 접속 불가.',
        updatedAt: '2025-09-26T08:00:00+09:00',
        statusLevel: 'informational',
        statusLabel: 'Postmortem 완료',
        statusIcon: 'activityDocs',
        incidents: [
          {
            id: 'incident-2025-09-dns',
            title: 'Secondary DNS Sync Delay',
            startedAt: '2025-09-12T14:06:00+09:00',
            resolvedAt: '2025-09-12T14:11:00+09:00',
            impact: 'minor',
            status: 'resolved',
            summary: 'Primary/Secondary NS 동기화가 11분 지연. 헬스 체크 알림 후 강제 sync로 복구.',
          },
          {
            id: 'followup-2025-09-dns',
            title: 'Failover 테스트 자동화',
            startedAt: '2025-09-13T10:00:00+09:00',
            impact: 'minor',
            status: 'monitoring',
            summary: '주 1회 synthetic failover 테스트 Cron Workers 작성 중.',
          },
        ],
        notes: '추가 액션: Cloudflare API 기반 재해 복구 시나리오 문서화 · PagerDuty 연동 검토.',
      },
    ],
  },
];
