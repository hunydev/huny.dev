...
const PlaygroundView: React.FC<{ onOpenFile: (fileId: string) => void }> = ({ onOpenFile }) => (
  <div className="p-2">
    ...
    <div className="flex flex-col gap-1">
      ...
      >
        <span className="inline-flex items-center justify-center w-4 h-4 mr-2 text-gray-400">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M3 10a1 1 0 0 1 1-1h1c2.761 0 5-2.239 5-5a1 1 0 1 1 2 0c0 3.86-3.14 7-7 7H4a1 1 0 0 1-1-1m15.5-5a.75.75 0 0 1 .75.75V18.5a.75.75 0 0 1-1.135.65l-4.5-2.75a.75.75 0 0 1-.365-.65V6.35a.75.75 0 0 1 .365-.65l4.5-2.75A.75.75 0 0 1 18.5 5"/></svg>
        </span>
